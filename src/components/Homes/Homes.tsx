...
export function Homes() {
    ...
    return (
        <section id="home" className="bg-amber-50 dark:bg-stone-900 h-[calc(100vh-5rem)] grid grid-cols-1 md:grid-cols-2 transition-colors duration-500">
            <div className="flex flex-col items-center mt-[6rem] px-4 md:px-0">
                <div>
                    <IamText />
            ...
            <div className="relative w-full h-80 md:h-full flex justify-center md:justify-end px-4 md:px-0 mt-8 md:mt-0">
